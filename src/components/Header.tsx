        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/donation" className="hidden sm:block">
              <Button className="bg-gradient-to-r from-primary via-purple-600 to-primary hover:from-purple-700 hover:via-primary hover:to-purple-700 text-primary-foreground font-semibold px-4 lg:px-6 text-sm relative overflow-hidden group transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/30">
                <Heart className="w-4 h-4 mr-2 relative z-10 transition-all duration-300 group-hover:animate-pulse group-hover:text-pink-200" />
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-white/10 via-pink-200/20 to-white/10 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out"></div>
              </Button>
            </Link>
                  ...
                  <div className="flex items-center justify-between mb-6">
                   ...
                   <div className="flex flex-col gap-3">
                    ...
                    <Link to="/donation" onClick={() => setIsOpen(false)}>
                      <Button className="w-full bg-gradient-to-r from-primary via-purple-600 to-primary hover:from-purple-700 hover:via-primary hover:to-purple-700 text-primary-foreground font-semibold py-3 text-lg mt-6 relative overflow-hidden group">
                        <Heart className="w-5 h-5 mr-2 transition-all duration-300 group-hover:animate-pulse group-hover:text-pink-200" />
