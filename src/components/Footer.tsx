      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Get Help</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Crisis Support</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Treatment Centers</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Recovery Resources</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Support Groups</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Family Support</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Our Mission</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Our Story</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">AI Technology</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Research</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Impact Reports</a></li>
        ...
        <div className="mt-12 p-6 bg-primary/20 rounded-lg border border-primary/30">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-4">If you or someone you know is in crisis, help is available right now.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <a href="tel:1-800-662-4357" className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-3 rounded-md font-semibold inline-block transition-colors border border-gray-600">
