          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-foreground/80 mb-12 leading-relaxed font-medium animate-fade-in max-w-4xl mx-auto">
                Genius Recovery was born out of a mission to change the way the world 
                understands and supports addiction recovery through compassion, education, and connection.
              </p>
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12 max-w-3xl mx-auto">
              Join Genius Recovery and start building the life you love. 
              No judgment—just support, resources, and a community that understands.
            </p>
